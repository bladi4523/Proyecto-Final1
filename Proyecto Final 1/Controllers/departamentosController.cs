...
namespace Proyecto_Final_1.Controllers
{
    public class departamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Dep,Codigo_Dep,Nombre")] departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Dep,Codigo_Dep,Nombre")] departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
